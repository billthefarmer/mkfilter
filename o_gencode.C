...
static void comp_fir()
{
    ...
    printf("        xv[NZEROS] = <i>next input value</i> / GAIN;\n");
    printf("        sum = 0.0;\n");
    printf("        for (i = 0; i <= NZEROS; i++) sum += (xcoeffs[i] * xv[i]);\n");
    printf("        <i>next output value</i> = sum;\n");
    printf("      }\n");
    printf("  }\n\n");
}
...
static void comp_iir()
{
    ...
    printf("  { for (;;)\n");
    printf("      { ");
    pr_shiftdown("xv", nzeros);
    putchar('\n');
    printf("        xv[%d] = <i>next input value</i> / GAIN;\n", nzeros);
    printf("        ");
    pr_shiftdown("yv", npoles);
    putchar('\n');
    printf("        yv[%d] =", npoles);
    pr_xpart("xv");
    pr_ypart("yv");
    printf(";\n");
    printf("        <i>next output value</i> = yv[%d];\n", npoles);
    printf("      }\n");
    printf("  }\n\n");
}
